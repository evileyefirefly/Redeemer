...
combatQuotes = {        --Used when casting Rebirth
    ...
    "%t--EARN IT!",
    "Warm fuzzy naturey things for you, %t...now get UP!",
...
ghoulQuotes = {     --Used when casting Raise Ally
    ...
    "Look, %t, I'm a soulless abomination, not a miracle worker!",
    "Who's coming back from the dead RIGHT NOW? %t's coming back from the dead RIGHT NOW!",
    "Every time I do this to %t, the apocalypse draws one step closer.",
    "%t, if any of your limbs fall off after this, it's completely your fault and has nothing to do with the influence of the Lich King.",
...
noghoulQuotes = {   --Used when casting Raise Dead
    ...
    "Even soulless abominations need a friend from time to time.",
    "All my friends keep falling apart.",
    "I always wonder where these guys keep coming from.",
    "Warm, fuzzy pets are for crazy cat people.",
    "Who's a snoochy ghoulie? You are! Yes you are a snoochy ghoulie!",
    
}

massQuotes = {  --Used when casting a Mass Resurrection Spell
    ...
    "I'm alive and you guys aren't--I'm not sayin', I'm just sayin'.",
...
otherQuotes = { --Used when casting Resurrection, Redemption, Ancestral Spirit, and Revive
    ...
    "The world will BURN before I resurrect %t! Oh...here goes then.",
